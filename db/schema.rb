...
ActiveRecord::Schema.define(version: 20170306184214) do
  ...
  create_table "authors_sources", force: :cascade do |t|
    t.integer "author_id"
    t.integer "source_id"
    t.index ["author_id"], name: "index_authors_sources_on_author_id"
